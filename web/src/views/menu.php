...
<div class="relative bg-[#FFFFFF] text-zinc-700 flex px-[3.75rem] space-x-12 justify-items-center items-center h-14 border-solid border-0 border-b-2 border-sky-500">
    <div class="Logo">
