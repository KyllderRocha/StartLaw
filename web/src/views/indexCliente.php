    ...
    <body class='bg-[#c6e6f5] min-h-screen h-fit text-zinc-700'>
        ...
        <div class="w-screen relative flex flex-col h-[94.1%]">
            ...
            <div class="bg-[#FFFFFF] mx-16 my-6 relative rounded-2xl px-14 py-5">
                <form class="grid grid-cols-4 gap-x-5 gap-y-3" action="#" method="POST" id="buscaClienteForm">
                    ...
                    <div class="flex items-center">
                        <button id="BtnBuscarCliente" class="grow bg-[#C1E8FA] appearance-none relative block px-3 py-2 border border-gray-300 placeholder-gray-500
